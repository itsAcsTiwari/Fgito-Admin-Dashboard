    ...
    return (
        <Fragment>
            <div className='py-3 px-4 space-y-6'>
                <h1 className='text-5xl uppercase tracking-wider'>Delivery Partners</h1>
                <div className='flex items-center border border-black rounded-md w-full md:w-1/2 lg:w-1/3 px-4'>
                    <Search className="h-4 w-4" />
                    <input type="text" className='border-none focus:border-none focus:ring-0 w-full' placeholder='Search Partners' />
                </div>
            </div>
            ...
            <div className='flex h-[calc(100vh-200px)] px-4 mt-4 mb-8 space-x-6'>
                ...
                {/* Right Section */}
                {selectedUser && (
                    <div className="w-3/5 h-full space-y-4 text-sm overflow-auto scrollbar-hide">
