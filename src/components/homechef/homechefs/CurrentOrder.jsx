        ...
        <Fragment>
            <div className="bg-grey w-full h-full px-8 py-6 my-2  rounded-md shadow-md">
                ...
                <div className="flex gap-10">
                    ...
                    <div className="flex flex-col flex-1 space-y-4 font-light">
                        <div>Order Placed Time <span>:</span> <span>01:00 pm</span></div>
                        <div>Order Accepted Time <span>:</span> <span>01:02 pm</span> </div>
                        ...
                        <div className="text-secondary-500 font-light">On Delivery</div>
                    </div>
